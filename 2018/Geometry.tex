...
\item Find the values of $p$ for which the following lines are perpendicular
  ...
  \item Find the direction cosines of the line joining  the points $P(4,3,-5)$ and $Q(-2,1,-8)$.
   \item Find the value of $\lambda$ for which the following lines are perpendicular to each other: $\frac{x-5}{5\lambda+2}= \frac{2-y}{5} = \frac{1-z}{-1}; \frac{x}{1}=\frac{y+\frac{1}{2}}{2\lambda}=\frac{z-1}{3}$. Hence,find whether the lines insert or not.
